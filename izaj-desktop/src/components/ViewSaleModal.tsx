...
export function ViewSaleModal({ 
  ...
  const getSaleStatus = () => {
    if (!saleDetails) return { text: 'No sale data', color: 'bg-gray-100 dark:bg-gray-900/30 text-gray-600 dark:text-gray-400' };
    ...
    if (now < startDate) {
      return { text: 'Upcoming Sale', color: 'bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' };
    } else if (now > endDate) {
      return { text: 'Sale Ended', color: 'bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400' };
    } else {
      return { text: 'Active Sale', color: 'bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400' };
    }
  };
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
              ...
              <div className="w-full lg:w-2/5 flex-shrink-0 pt-4 pb-4 flex justify-end ml-8">
                {mediaUrls.length > 0 ? (
                  ...
                  <div className="w-full max-w-lg mx-auto bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800 dark:to-slate-900 rounded-2xl flex items-center justify-center h-[500px] border border-gray-200 dark:border-slate-800">
              ...
              <div className="w-full lg:w-3/5 flex flex-col gap-6 p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-slate-50 dark:from-slate-800 dark:to-slate-900 rounded-2xl p-5 border border-gray-100 dark:border-slate-700">
                    <div className="flex items-center gap-2 mb-2">
                      <Icon icon="mdi:currency-usd" className="text-lg text-gray-600 dark:text-slate-400" />
                      <span className="text-sm text-gray-600 dark:text-slate-400 font-semibold uppercase tracking-wide">Original Price</span>
                    </div>
                    <span className="text-2xl font-bold text-gray-700 dark:text-slate-200" style={{ fontFamily: "'Jost', sans-serif" }}>
                  ...
                  <div className="bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 rounded-2xl p-5 border border-orange-100 dark:border-orange-800">
                    <div className="flex items-center gap-2 mb-2">
                      <Icon icon="mdi:store" className="text-lg text-orange-600 dark:text-orange-400" />
                      <span className="text-sm text-orange-600 dark:text-orange-400 font-semibold uppercase tracking-wide">Branch</span>
                    </div>
                    <span className="text-lg font-semibold text-orange-700 dark:text-orange-300" style={{ fontFamily: "'Jost', sans-serif" }}>
                      {sale.branch}
                    </span>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-gray-50 to-slate-50 dark:from-slate-800 dark:to-slate-900 rounded-2xl p-6 border border-gray-100 dark:border-slate-700">
                  ...
                  <p className="text-gray-700 dark:text-slate-200 text-base" style={{ fontFamily: "'Jost', sans-serif" }}>
          ...
          {saleDetails && (
            <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-lg border border-gray-100 dark:border-slate-700 overflow-hidden">
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl p-6 border border-green-100 dark:border-green-800">
                    <div className="flex items-center gap-3 mb-4">
                      <Icon icon="mdi:currency-usd" className="text-2xl text-green-600 dark:text-green-400" />
                      <span className="text-sm text-green-600 dark:text-green-400 font-semibold uppercase tracking-wide">Pricing</span>
                    </div>
                    
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-600 dark:text-slate-400" style={{ fontFamily: "'Jost', sans-serif" }}>Original Price</span>
                        <span className="text-lg font-semibold text-gray-800 dark:text-slate-100" style={{ fontFamily: "'Jost', sans-serif" }}>₱{sale.price.toLocaleString()}</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-600 dark:text-slate-400" style={{ fontFamily: "'Jost', sans-serif" }}>Discount</span>
                        <span className="text-lg font-semibold text-red-600 dark:text-red-400" style={{ fontFamily: "'Jost', sans-serif" }}>{getDiscountText()}</span>
                      </div>
                      <div className="flex items-center justify-between border-t border-green-200 dark:border-green-800 pt-3">
                        <span className="text-base font-medium text-gray-700 dark:text-slate-200" style={{ fontFamily: "'Jost', sans-serif" }}>Sale Price</span>
                        <span className="text-2xl font-bold text-green-600 dark:text-green-400" style={{ fontFamily: "'Jost', sans-serif" }}>₱{getDiscountedPrice().toLocaleString()}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-6 border border-blue-100 dark:border-blue-800">
                    <div className="flex items-center gap-3 mb-4">
                      <Icon icon="mdi:calendar-range" className="text-2xl text-blue-600 dark:text-blue-400" />
                      <span className="text-sm text-blue-600 dark:text-blue-400 font-semibold uppercase tracking-wide">Sale Period</span>
                    </div>
                    
                    <div className="space-y-4">
                      <div>
                        <span className="text-sm text-gray-600 dark:text-slate-400 block mb-1" style={{ fontFamily: "'Jost', sans-serif" }}>Start Date</span>
                        <div className="font-medium text-gray-800 dark:text-slate-100" style={{ fontFamily: "'Jost', sans-serif" }}>{formatDate(saleDetails.start_date)}</div>
                        <div className="text-xs text-gray-500 dark:text-slate-400" style={{ fontFamily: "'Jost', sans-serif" }}>{formatTime(saleDetails.start_date)}</div>
                      </div>
                      
                      <div>
                        <span className="text-sm text-gray-600 dark:text-slate-400 block mb-1" style={{ fontFamily: "'Jost', sans-serif" }}>End Date</span>
                        <div className="font-medium text-gray-800 dark:text-slate-100" style={{ fontFamily: "'Jost', sans-serif" }}>{formatDate(saleDetails.end_date)}</div>
                        <div className="text-xs text-gray-500 dark:text-slate-400" style={{ fontFamily: "'Jost', sans-serif" }}>{formatTime(saleDetails.end_date)}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* Sale Status */}
                <div className="mt-6 bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20 rounded-2xl p-6 border border-purple-100 dark:border-purple-800">
                  <div className="flex items-center gap-3 mb-4">
                    <Icon icon="mdi:clock-outline" className="text-2xl text-purple-600 dark:text-purple-400" />
                    <span className="text-sm text-purple-600 dark:text-purple-400 font-semibold uppercase tracking-wide">Current Status</span>
                  </div>
